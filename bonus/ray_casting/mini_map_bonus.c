...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/11 10:04:22 by abouramd          #+#    #+#             */
/*   Updated: 2023/08/11 10:04:23 by abouramd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_map(t_mini *mini, int x, int y)
{
	...
	else if (mini->x_start >= MINI_WIDTH - 5 || mini->y_start >= MINI_HEIGHT
		- 5)
		my_mlx_pixel_put(mini->img, mini->x_start, mini->y_start, GREEN);
	...
	else if (mini->y_d == (int)(y / MINI_CUBE) && mini->x_d == (int)(x
				/ MINI_CUBE))
