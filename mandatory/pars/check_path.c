...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/11 10:10:02 by abouramd          #+#    #+#             */
/*   Updated: 2023/08/11 10:10:03 by abouramd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_file_name(const char *str, char *ext, char *err)
{
	...
	if (len <= extlen || (ft_strrchr(str, '/')
			&& ft_strlen(ft_strrchr(str, '/') + 1) <= extlen))
...
{
	if (check_file_name(str, ".cub", "Filename end with .cub") == -1)
		return (-1);
